...
const AppContent: React.FC = () => {
    return (
        <main className="w-full max-w-7xl p-2 md:p-4 lg:p-6 grid grid-cols-1 lg:grid-cols-12 gap-3 md:gap-6 lg:gap-8 pb-[360px] lg:pb-6">
            ...
            <div className="fixed bottom-0 left-0 right-0 z-50 lg:static lg:col-span-7 flex flex-col bg-[#111] rounded-t-3xl lg:rounded-3xl border-t lg:border border-[#222] p-4 lg:p-8 relative overflow-hidden min-h-[300px] lg:min-h-[500px] shadow-[0_-10px_40px_rgba(0,0,0,0.5)] lg:shadow-none">
