...
const AppContent: React.FC = () => {
    return (
        <main className="w-full max-w-7xl p-2 md:p-4 lg:p-6 grid grid-cols-1 lg:grid-cols-12 gap-3 md:gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-7 flex flex-col bg-[#111] rounded-3xl border border-[#222] p-2 lg:p-8 relative overflow-hidden min-h-[500px]">
                ...
                <div className="flex-1 flex items-start justify-center w-full mt-12 lg:mt-24">
                    <Piano />
                </div>
            </div>
        </main>
